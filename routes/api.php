...
use App\Http\Controllers\ServiceLandingPageController;
...
Route::get('/services-landing-pages', [ServiceLandingPageController::class, 'index']);
Route::get('/services-landing-pages/{id}', [ServiceLandingPageController::class, 'show']);
...
Route::middleware('auth:sanctum')->prefix('admin')->group(function () {
    ...
    Route::apiResource('services-landing-pages', ServiceLandingPageController::class);
